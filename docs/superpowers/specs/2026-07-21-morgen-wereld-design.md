...
1. **Interactiemodel: hybride.** Korte, skipbare intro-vlucht (autoplay, geen scroll) landt op een hub. Klik op een gebouw start een camera-dive naar binnen; het binnen-verhaal is wel scroll-gescrubd. Binnen volgt per gebouw een kort scroll-verhaal met de content van die pilaar als overlay-secties. Uitgang onderaan: terug naar de hub of door naar het volgende gebouw. Een gewone nav-balk blijft er bovenop staan.
